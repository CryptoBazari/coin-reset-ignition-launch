...
-- Phase 1: Database Schema for Data Persistence & Quality
...
-- Allow public read access to historical data
...
-- Add columns to existing coins table for better tracking
...
-- Update existing coins to mark current data as estimated
UPDATE public.coins 
SET calculation_data_source = 'estimated',
    confidence_level = 'low',
    data_quality_score = 20
WHERE calculation_data_source IS NULL OR calculation_data_source = '';
