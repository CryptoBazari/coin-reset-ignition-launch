...
export const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-500/20 rounded-full blur-3xl animate-pulse transform-gpu" style={{
        transform: 'translateZ(50px)'
      }} />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600/15 rounded-full blur-3xl animate-pulse transform-gpu" style={{
        animationDelay: '1s',
        transform: 'translateZ(30px)'
      }} />
        <div className="absolute top-3/4 left-3/4 w-48 h-48 bg-blue-400/25 rounded-full blur-3xl animate-pulse transform-gpu" style={{
        animationDelay: '2s',
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="mb-6">
          <span className="inline-flex items-center px-4 py-2 rounded-full bg-blue-600/20 text-blue-100 text-sm font-medium mb-8 animate-bounce backdrop-blur-sm border border-blue-500/30">
            <Star className="h-4 w-4 mr-2 animate-spin" style={{
        ...
        }} className="block bg-gradient-to-r from-white via-cyan-200 to-blue-200 bg-clip-text font-extrabold drop-shadow-2xl animate-pulse text-[#00eaff]/[0.69]">CoinPlatform</span>
        </h1>
        ...
        <div className="absolute top-1/2 left-8 animate-bounce delay-1000 hidden lg:block transform-gpu" style={{
        transform: 'translateZ(40px)'
      }}>
          <TrendingUp className="h-8 w-8 text-blue-400/60" />
        </div>
        <div className="absolute top-1/3 right-8 animate-bounce delay-1500 hidden lg:block transform-gpu" style={{
        transform: 'translateZ(30px)'
      }}>
          <Star className="h-6 w-6 text-blue-300/60 animate-spin" style={{
